...
for (let [abreviatura, nombre_completo] of modulos)
  cadena_respuesta +=
    "Abreviatura: " + abreviatura + "; Nombre completo: " + nombre_completo + ".\n";
console.log(cadena_respuesta);
...
if (modulos.has(modulo_buscado)) {
  ...
  cadena_respuesta +=
    "Se ha cambiado correctamente el nombre completo del módulo " +
    modulo_buscado +
    ". Ahora es: " +
    modulos.get(modulo_buscado) +
    ".";
} else {
...
cadena_respuesta =
  "g. Si está, elimínalo y vuelve a mistrar todos los módulos para comprobar el borrado.\n\n";
...
if (modulos.delete(modulo_buscado)) {
  cadena_respuesta +=
    ...
    modulo_buscado +
    " correctamente. A continuación se muestran los módulos guardados.\n\n";
  // Nuevamente recorro los elementos del mapa en un bucle
  for (let [abreviatura, nombre_completo] of modulos)
    cadena_respuesta +=
      "Abreviatura: " + abreviatura + "; Nombre completo: " + nombre_completo + ".\n";
} else
  cadena_respuesta += "No se ha eliminado el módulo " + modulo_buscado + " dado que no existe.";
console.log(cadena_respuesta);
