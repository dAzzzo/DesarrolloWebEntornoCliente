...
class Club{
    constructor(anioFundacion = 'No especificado', numSocios = 0, nombreEstadio = 'No especificado', ciudad = 'No especificado', palmares = []){
...
const club6 = new Club(1952, 7264, "Cruspian", "Cadiz", [{nombre: 'Torneo A', anio: 1956}, {nombre: 'Torneo B', anio: 1968}]);
