...
for (let [abreviatura, nCompleto] of modulos) respuesta += "Abreviatura: " + abreviatura + ".\n";
console.log(respuesta);
...
for (let [abreviatura, nCompleto] of modulos) respuesta += "Nombre completo: " + nCompleto + ".\n";
console.log(respuesta);
